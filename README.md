...
- **Brightness_Increment**: Increase brightness - _brightnessctl_ for internal, _ddcutil_ for external monitors
- **Brightness_Decrement**: Decrease brightness - _brightnessctl_ for internal, _ddcutil_ for external monitors
